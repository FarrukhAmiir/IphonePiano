...
public class VunglePostBuilder : MonoBehaviour
{
	...
	private static void onPostProcessBuildPlayer( BuildTarget target, string pathToBuiltProject )
	{
		...
		#endif
		{
			...
			var scriptPath = Path.Combine( Application.dataPath, "Plugins/Editor/Vungle/VunglePostProcessor.py" );
			...
			var pathToNativeCodeFiles = Path.Combine( Application.dataPath, "Plugins/Editor/Vungle/VungleResources" );
