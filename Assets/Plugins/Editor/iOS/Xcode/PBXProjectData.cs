...
namespace TDEditor.iOS.Xcode
{
    ...
    internal class PBXProjectData
    {
        ...
        private Dictionary<string, PBXCopyFilesBuildPhaseData> embedFrameworks = new Dictionary<string, PBXCopyFilesBuildPhaseData>();
        ...
        public void Clear()
        {
            ...
            embedFrameworks = new Dictionary<string, PBXCopyFilesBuildPhaseData>();
